...
- Los objetos de una subclase deben poder sustituir a los objetos de la clase base sin alterar el comportamiento
...
- Esto rompe LSP, porque si tenemos código que llama al método "volar" de la clase "Ave", si recibe un objeto de
  la subclase "Pinguino" fallará.

## Ejemplo correcto

- La clase abstracta (podría ser una interfaz) Ave tiene un método abstracto "mover()"
- Tenemos una clase "AveVoladora", que extiende "Ave" y tiene un método "volar". La implementación de mover llama a
  volar.
