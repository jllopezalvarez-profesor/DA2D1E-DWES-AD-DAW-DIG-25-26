INSERT INTO students (dni, first_name, last_name, birth_date)
VALUES ('10000001A', 'Juan', 'Pérez Gómez', '2003-05-14'),
       ('10000002B', 'María', 'López Sánchez', '2004-02-03'),
       ('10000003C', 'Antonio', 'Martín Ruiz', '2002-11-21'),
       ('10000004D', 'Laura', 'García Fernández', '2003-07-09'),
       ('10000005E', 'Carlos', 'Sánchez Molina', '2001-09-30'),
       ('10000006F', 'Ana', 'Romero Díaz', '2004-01-18'),
       ('10000007G', 'David', 'Navarro Torres', '2002-04-26'),
       ('10000008H', 'Lucía', 'Ortega Ramos', '2003-12-05'),
       ('10000009J', 'Jorge', 'Molina Cruz', '2001-06-11'),
       ('10000010K', 'Paula', 'Gil Moreno', '2004-08-22'),
       ('10000011L', 'Sergio', 'Hernández Vega', '2002-10-02'),
       ('10000012M', 'Claudia', 'Castro León', '2003-03-17'),
       ('10000013N', 'Iván', 'Prieto Blanco', '2001-01-29'),
       ('10000014P', 'Natalia', 'Suárez Campos', '2004-06-07'),
       ('10000015Q', 'Rubén', 'Iglesias Fuentes', '2002-09-14'),
       ('10000016R', 'Elena', 'Cabrera Nieto', '2003-11-25'),
       ('10000017S', 'Miguel', 'Vargas Pardo', '2001-04-08'),
       ('10000018T', 'Sara', 'Méndez Ríos', '2004-02-19'),
       ('10000019U', 'Álvaro', 'Rey Lorenzo', '2002-07-01'),
       ('10000020V', 'Irene', 'Flores Bautista', '2003-10-12');
